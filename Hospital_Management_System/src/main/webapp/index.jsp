...
<body>
	...
	<div class="container p-3">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<img alt="" src="img/doc5.png" height="410px" width="450px">
			</div>
	...
	<div class="container p-2">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/doc1.jpeg" width="250px" height="250px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/doc3.jpeg" width="250px" height="250px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/doc4.jpg" width="250px" height="250px">
